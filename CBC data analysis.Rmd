...
comparative_cbc <- ggplot(bar_plot_input,
  ...
  scale_x_discrete(labels = c("Human_2017_18"     = "2017-18",
...
tab_model(neu_pre, show.stat = TRUE)
...
# Pairwise: infection status within each environment and strain
# Pre-RW (no environment effect yet)
emm_neu_pre_pairs <- emmeans(neu_pre,
                             specs = "t_muris_dose",
                             by = "strain",
                             type = "response")

kable(pairs(emm_neu_pre_pairs),
      caption = "Neutrophil Pre-RW: Pairwise Comparisons of Infection Status by Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)

# During RW: infection within each environment x strain
emm_neu_during_pairs <- emmeans(neu_during,
                                specs = "t_muris_dose",
                                by = c("lab_or_rw", "strain"),
                                type = "response")

kable(pairs(emm_neu_during_pairs),
      caption = "Neutrophil During-RW: Pairwise Comparisons of Infection Status by Environment and Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)

# Post-RW: infection within each environment x strain
emm_neu_post_pairs <- emmeans(neu_post,
                              specs = "t_muris_dose",
                              by = c("lab_or_rw", "strain"),
                              type = "response")

kable(pairs(emm_neu_post_pairs),
      caption = "Neutrophil Post-RW: Pairwise Comparisons of Infection Status by Environment and Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)
...
emm_lym_pre_pairs <- emmeans(lym_pre,
                             specs = "t_muris_dose",
                             by = "strain",
                             type = "response")

kable(pairs(emm_lym_pre_pairs),
      caption = "Lymphocyte Pre-RW: Pairwise Comparisons of Infection Status by Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)

emm_lym_during_pairs <- emmeans(lym_during,
                                specs = "t_muris_dose",
                                by = c("lab_or_rw", "strain"),
                                type = "response")

kable(pairs(emm_lym_during_pairs),
      caption = "Lymphocyte During-RW: Pairwise Comparisons of Infection Status by Environment and Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)

emm_lym_post_pairs <- emmeans(lym_post,
                              specs = "t_muris_dose",
                              by = c("lab_or_rw", "strain"),
                              type = "response")

kable(pairs(emm_lym_post_pairs),
      caption = "Lymphocyte Post-RW: Pairwise Comparisons of Infection Status by Environment and Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)
...
emm_mon_pre_pairs <- emmeans(mon_pre,
                             specs = "t_muris_dose",
                             by = "strain",
                             type = "response")

kable(pairs(emm_mon_pre_pairs),
      caption = "Monocyte Pre-RW: Pairwise Comparisons of Infection Status by Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)

emm_mon_during_pairs <- emmeans(mon_during,
                                specs = "t_muris_dose",
                                by = c("lab_or_rw", "strain"),
                                type = "response")

kable(pairs(emm_mon_during_pairs),
      caption = "Monocyte During-RW: Pairwise Comparisons of Infection Status by Environment and Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)

emm_mon_post_pairs <- emmeans(mon_post,
                              specs = "t_muris_dose",
                              by = c("lab_or_rw", "strain"),
                              type = "response")

kable(pairs(emm_mon_post_pairs),
      caption = "Monocyte Post-RW: Pairwise Comparisons of Infection Status by Environment and Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)
...
emm_eos_pre_pairs <- emmeans(eos_pre,
                             specs = "t_muris_dose",
                             by = "strain")

kable(pairs(emm_eos_pre_pairs),
      caption = "Eosinophil Pre-RW: Pairwise Comparisons of Infection Status by Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)

emm_eos_during_pairs <- emmeans(eos_during,
                                specs = "t_muris_dose",
                                by = c("lab_or_rw", "strain"))

kable(pairs(emm_eos_during_pairs),
      caption = "Eosinophil During-RW: Pairwise Comparisons of Infection Status by Environment and Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)

emm_eos_post_pairs <- emmeans(eos_post,
                              specs = "t_muris_dose",
                              by = c("lab_or_rw", "strain"))

kable(pairs(emm_eos_post_pairs),
      caption = "Eosinophil Post-RW: Pairwise Comparisons of Infection Status by Environment and Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)
...
emm_bas_pre_pairs <- emmeans(bas_pre,
                             specs = "t_muris_dose",
                             by = "strain")

kable(pairs(emm_bas_pre_pairs),
      caption = "Basophil Pre-RW: Pairwise Comparisons of Infection Status by Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)

emm_bas_during_pairs <- emmeans(bas_during,
                                specs = "t_muris_dose",
                                by = c("lab_or_rw", "strain"))

kable(pairs(emm_bas_during_pairs),
      caption = "Basophil During-RW: Pairwise Comparisons of Infection Status by Environment and Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)

emm_bas_post_pairs <- emmeans(bas_post,
                              specs = "t_muris_dose",
                              by = c("lab_or_rw", "strain"))

kable(pairs(emm_bas_post_pairs),
      caption = "Basophil Post-RW: Pairwise Comparisons of Infection Status by Environment and Strain",
      digits = 3) %>%
  kable_styling(full_width = FALSE)
