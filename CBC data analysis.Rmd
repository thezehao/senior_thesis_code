...
comparative_cbc <- ggplot(bar_plot_input,
  ...
  scale_x_discrete(limits = c("Human_2017_18",
                              "Human_2021_23",
                              "C57BL/6J Zero Lab",
                              "C57BL/6J Low Lab",
                              "C57BL/6J High Lab",
                              ...
                              "B10.BR Low RW",
                              "B10.BR High RW"),
                   labels = c("Human_2017_18" = "2017-18",
                              "Human_2021_23" = "2021-23",
...
human_cbc <- bind_rows(cleaned_nhanes_data_2017_18 %>% 
                         mutate(nhanes_year = "2017_18"),
                       cleaned_nhanes_data_2021_23 %>%
                         mutate(nhanes_year = "2021_23")) %>%
  select(all_of(cbc_percent), nhanes_year) %>%
